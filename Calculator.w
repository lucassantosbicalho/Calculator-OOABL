...
&Scoped-Define ENABLED-OBJECTS RECT-1 RECT-2 bt7 bt8 bt9 btDivide bt4 bt5 ~
bt6 btMultiply bt1 bt2 bt3 btSubtract btClear bt0 btVirg btAdd btResult ~
filScreen 
&Scoped-Define DISPLAYED-OBJECTS filScreen 
...
DEFINE VARIABLE filScreen AS CHARACTER FORMAT "X(20)":U 
      VIEW-AS TEXT 
...
DEFINE FRAME frMain
     ...
     "Calculator LB-567" VIEW-AS TEXT
          SIZE 17.6 BY .62 AT ROW 1.19 COL 33.4 RIGHT-ALIGNED WIDGET-ID 46
...
/* SETTINGS FOR TEXT-LITERAL "Calculator LB-567"
          SIZE 17.6 BY .62 AT ROW 1.19 COL 33.4 RIGHT-ALIGNED           */
...
------------------------------------------------------------------------------*/
  ...
  ENABLE RECT-1 RECT-2 bt7 bt8 bt9 btDivide bt4 bt5 bt6 btMultiply bt1 bt2 bt3 
         btSubtract btClear bt0 btVirg btAdd btResult filScreen 
      WITH FRAME frMain IN WINDOW C-Win.
